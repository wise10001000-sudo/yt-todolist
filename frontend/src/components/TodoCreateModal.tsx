...
interface TodoCreateModalProps {
  open: boolean;
  onClose: () => void;
  onCreate: (todoData: Omit<Todo, 'id' | 'status' | 'createdAt' | 'updatedAt'>) => Promise<boolean>;
}

const TodoCreateModal: React.FC<TodoCreateModalProps> = ({ open, onClose, onCreate }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError('할일 생성 중 오류가 발생했습니다. 다시 시도해주세요.');
    } finally {
